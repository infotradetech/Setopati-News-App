...
#import "DataParser.h"
@interface NSpecialViewController ()
{
...
@implementation NSpecialViewController
...
- (void)viewDidLoad
{
    ...
    setopatiList=[app ngetSetopatisList5];
