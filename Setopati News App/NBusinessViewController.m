...
#import "DataParser.h"
@interface NBusinessViewController ()
{
...
@implementation NBusinessViewController
...
- (void)viewDidLoad
{
    ...
    setopatiList=[app ngetSetopatisList2];
