...
#import "DataParser.h"
@interface NOpinionViewController ()
{
...
@implementation NOpinionViewController
...
- (void)viewDidLoad
{
    ...
    setopatiList=[app ngetSetopatisList6];
